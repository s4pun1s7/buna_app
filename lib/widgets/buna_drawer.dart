...
class BunaDrawer extends ConsumerWidget {
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                if (FeatureFlags.allInteractiveFeaturesEnabled) _buildInteractiveFeatures(context),
                if (FeatureFlags.allInteractiveFeaturesEnabled && FeatureFlags.allSupportFeaturesEnabled) const Divider(),
                if (FeatureFlags.allSupportFeaturesEnabled) _buildSupportFeatures(context),
              ],
            ),
          ),
              ...
              child: OutlinedButton.icon(
                ...
                onPressed: () async {
                  showDialog(
                    ...
                    builder: (_) => const AnimatedLoadingDialog(message: 'Signing out...'),
                  );
                  try {
  ...
  Widget _buildDrawerHeader(BuildContext context, AsyncValue<User?> userAsync) {
    ...
    final isGoogle = user != null && user.providerData.any((p) => p.providerId == 'google.com');
